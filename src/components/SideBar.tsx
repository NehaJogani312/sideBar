...
import toggleLogo from '../assets/icon.png'
  ...
  return (
    <>
      <div className={style.toggleIcon}>
        <div className={style.toggleBtn} onClick={openToggel}>
          <RxTextAlignLeft />
        </div>
        <div className={style.toggleLogo}>
      ...
      <div className={`${style.sideBar} ${openNav ? style.sideBarToggle : style.sideBar}`}  >
        <div className={style.fixLogo}>
          <Link to="/" className={style.logo}>
            <img src={logoImg} alt="logo image" />
          </Link>
          <div className={style.closeToggle} onClick={closeToggle}>
            <CgCloseO />
          </div>
        </div>
